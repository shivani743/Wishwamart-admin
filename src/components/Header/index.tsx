...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white dark:bg-boxdark">
      <div className="flex flex-grow items-center justify-between px-4 py-4 md:px-6 2xl:px-11 bg-[#eef5ff]">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5  dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
